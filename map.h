...
/**
 * Add a DOOR item at (x,y). If there is already a MapItem at (x,y), erase it
 * before adding the door.
 */
void add_door(int x, int y);

/**
 * Add a SPIKES item at (x,y). If there is already a MapItem at (x,y), erase it
 * before adding the spikes.
 */
void add_spikes(int x, int y);

/**
 * Add a WATER item at (x,y). If there is already a MapItem at (x,y), erase it
 * before adding the water.
 */
void add_water(int x, int y);

/**
 * Add a SKELETON item at (x,y). If there is already a MapItem at (x,y), erase it
 * before adding the skeleton.
 */
...
/**
 * Add a CHEST item at (x,y). If there is already a MapItem at (x,y), erase it
 * before adding the chest.
 */
void add_chest(int x, int y);

/**
 * Add a NPC at (x,y). If there is already a MapItem at (x,y), erase it
 * before adding the NPC.
 */
void add_NPC(int x, int y);

/**
 * Add a heart at (x,y). If there is already a MapItem at (x,y), erase it
 * before adding the heart.
 */
void add_heart(int x, int y);

/**
 * Add a spear at (x,y). If there is already a MapItem at (x,y), erase it
 * before adding the spear.
 */
